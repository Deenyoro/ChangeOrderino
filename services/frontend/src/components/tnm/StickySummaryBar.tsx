            ...
            <>
              <div className="flex items-center justify-center mb-3">
                <div className="text-center">
                  <div className="text-sm font-medium text-gray-700 mb-1">Prices Hidden During Creation</div>
                  <div className="text-xs text-gray-500">Pricing will be set during approval</div>
                </div>
              </div>
            </>
          ) : (
          ...
          {hidePrices ? (
            <>
              <div className="flex items-center justify-center mb-4 py-4">
                <div className="text-center">
                  <div className="text-lg font-semibold text-gray-700 mb-2">Prices Hidden During Initial Creation</div>
                  <div className="text-sm text-gray-500">Pricing and rates will be set during the approval process</div>
                </div>
              </div>
            </>
          ) : (
